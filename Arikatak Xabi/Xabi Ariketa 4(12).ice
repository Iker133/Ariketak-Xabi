    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Ejemplo 12: Segundero  \n\nCon un corazon de tics que esta puesto para un segundo y cada vez que le llega esa señal de un segundo al contador lo cuenta y cuando llega a 9 se resetea.",
            "readonly": true
          },
          "position": {
            "x": -296,
