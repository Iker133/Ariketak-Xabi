    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Ejemplo 14: Secuencia en los LEDs: KITT  \n\ncon la señal que da el corazon va contamdo el contador y con eso va almacenando en la tabla de posiciones y asi va encenciendose y apagandose de uno en uno y cuando de la vuelta se reseteara.",
            "readonly": true
          },
          "position": {
            "x": -224,
