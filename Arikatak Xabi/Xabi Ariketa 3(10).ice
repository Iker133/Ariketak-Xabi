    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Ejemplo 10: Escaner supermercado\nTenemos un sensor de infrarrojos, cuando pase el objeto pitara y se encendera una led. Luego tenemos una puerta logica de and que sus entradas son del pitido y el latido encendera una led. La salida del pitido llega a un contador que envia la informacion a un display que se marcara la cantidad de objetos que han pasado por el sensor y para resetear el contador tenemos un boton de reset.",
            "readonly": true
          },
          "position": {
            "x": -120,
